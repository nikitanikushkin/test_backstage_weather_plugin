...
async function createRouter(options) {
  ...
  router.get(
    ...
    async (req, res) => {
      ...
      logger.info(
        `Search request received: term="${query.term}", filters=${JSON.stringify(query.filters)}, types=${query.types ? query.types.join(",") : ""}, pageCursor=${(_a2 = query.pageCursor) != null ? _a2 : ""}`
      );
