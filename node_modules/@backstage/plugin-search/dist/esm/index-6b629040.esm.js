import React, { useRef, useEffect, useCallback, useContext, useState, Fragment, cloneElement } from 'react';
import { useNavigate, useOutlet, useLocation } from 'react-router-dom';
import { Dialog, useTheme, DialogTitle, Paper, DialogContent, Grid, Divider, DialogActions, makeStyles as makeStyles$1, Card, CardHeader, CardContent, Accordion, AccordionSummary, AccordionDetails, List, ListItem, ListItemIcon, ListItemText, Tabs, Tab, FormControl, InputLabel, Select, Chip, MenuItem, Checkbox } from '@material-ui/core';
...
const SearchPage$1 = searchPlugin.provide(
  createRoutableExtension({
    name: "SearchPage",
    component: () => import('./index-31db8e7f.esm.js').then((m) => m.SearchPage),
...
const SidebarSearchModal = searchPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./index-d9589b12.esm.js').then(
...
const HomePageSearchBar = searchPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./index-c2771afe.esm.js').then((m) => m.HomePageSearchBar)
    }
  })
);
...
const Modal = ({ toggleModal }) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(DialogTitle, null, /* @__PURE__ */ React.createElement(Paper, { className: classes.container }, /* @__PURE__ */ React.createElement(
    SearchBar,
    {
    ...
    /* @__PURE__ */ React.createElement(Grid, { item: true }, /* @__PURE__ */ React.createElement(Link, { to: searchPagePath, onClick: handleSearchResultClick }, /* @__PURE__ */ React.createElement(Typography, { component: "span", className: classes.viewResultsLink }, "View Full Results"), /* @__PURE__ */ React.createElement(LaunchIcon, { color: "primary" })))
...
//# sourceMappingURL=index-6b629040.esm.js.map
