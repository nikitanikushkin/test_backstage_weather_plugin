...
const RadarDescription = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(Dialog, { "data-testid": "radar-description", open, onClose }, /* @__PURE__ */ React.createElement(DialogTitle, { "data-testid": "radar-description-dialog-title" }, title), /* @__PURE__ */ React.createElement(DialogContent, { dividers: true }, /* @__PURE__ */ React.createElement(MarkdownContent, { content: description })), showDialogActions(url, links) && /* @__PURE__ */ React.createElement(DialogActions, null, links == null ? void 0 : links.map((link) => /* @__PURE__ */ React.createElement(
    Button,
    {
      component: Link,
      to: link.url,
