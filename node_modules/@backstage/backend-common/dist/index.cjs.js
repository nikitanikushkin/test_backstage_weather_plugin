...
const redacter = backendAppApi.WinstonLogger.redacter();
const setRootLoggerRedactionList = redacter.add;
function redactWinstonLogLine(info) {
  return redacter.format.transform(info);
}
const coloredFormat = backendAppApi.WinstonLogger.colorFormat();
...
const _DefaultCacheClient = class {
