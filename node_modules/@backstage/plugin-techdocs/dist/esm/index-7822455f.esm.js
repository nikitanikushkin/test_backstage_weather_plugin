...
const TechDocsSearchResultListItem$1 = (props) => {
  ...
  const ListItemWrapper = ({ children }) => asListItem ? /* @__PURE__ */ React.createElement(React.Fragment, null, icon && /* @__PURE__ */ React.createElement(ListItemIcon, null, icon), /* @__PURE__ */ React.createElement("div", { className: classes.flexContainer }, children)) : /* @__PURE__ */ React.createElement(React.Fragment, null, children);
...
const TechDocsCustomHome = techdocsPlugin.provide(
  createRoutableExtension({
    ...
    component: () => import('./TechDocsCustomHome-a4e83d73.esm.js').then(
...
const TechDocsReaderPage = techdocsPlugin.provide(
  createRoutableExtension({
    ...
    component: () => import('./index-8d041ffc.esm.js').then(
...
//# sourceMappingURL=index-7822455f.esm.js.map
