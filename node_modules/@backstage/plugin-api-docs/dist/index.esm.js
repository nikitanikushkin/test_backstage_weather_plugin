...
const LazyAsyncApiDefinition = React.lazy(
  () => import('./esm/AsyncApiDefinition-dc00c4ef.esm.js').then((m) => ({
...
const ApiExplorerPage = apiDocsPlugin.provide(
  createRoutableExtension({
    ...
    component: () => import('./esm/index-43f5e643.esm.js').then((m) => m.ApiExplorerIndexPage),
...
const EntityApiDefinitionCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-883d29bc.esm.js').then((m) => m.ApiDefinitionCard)
    }
  })
);
const EntityConsumedApisCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-7bf56f22.esm.js').then((m) => m.ConsumedApisCard)
    }
  })
);
const EntityConsumingComponentsCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-afda4d5b.esm.js').then(
...
const EntityProvidedApisCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-7bf56f22.esm.js').then((m) => m.ProvidedApisCard)
    }
  })
);
...
const EntityHasApisCard = apiDocsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-7bf56f22.esm.js').then((m) => m.HasApisCard)
    }
  })
);
